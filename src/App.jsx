...
import RecoltePdt from './pages/RecoltePdt'
...
import PlantsPDT from './pages/PlantsPdt'
...
const NAV_AGRICOLE = [
  ...
  { group: 'Champ', items: [
    ...
    { id: 'plants-pdt',     label: 'Plants PDT',         icon: IconPlant },
    { id: 'recolte-pdt',    label: 'Récolte PDT',        icon: IconBalance },
    { id: 'mesparcelles',   label: 'MesParcelles',       icon: IconMesParcelles },
  ]},
  { group: 'Suivi', items: [
...
function IconPlant()     { return <SI><path d="M12 22V10"/><path d="M5 10a7 7 0 0 0 7 7"/><path d="M19 10a7 7 0 0 1-7 7"/><path d="M5 5a7 7 0 0 0 7 5 7 7 0 0 0 7-5"/></SI> }
...
function IconBalance()   { return <SI><path d="M12 3v18"/><path d="M5 21h14"/><path d="M3 7h18"/><path d="M6 7l-3 6a3 3 0 0 0 6 0l-3-6z"/><path d="M18 7l-3 6a3 3 0 0 0 6 0l-3-6z"/></SI> }
...
function IconMesParcelles() { return <SI><rect x="3" y="3" width="8" height="8" rx="1.5"/><rect x="13" y="3" width="8" height="8" rx="1.5"/><rect x="3" y="13" width="8" height="8" rx="1.5"/><rect x="13" y="13" width="8" height="8" rx="1.5"/><path d="M9 9l3-3"/><path d="M15 9l-3-3"/></SI> }
...
function PageRouter({ section, pageProps = {} }) {
  ...
  return (
    <>
      ...
      {section==='mesparcelles' && <MesParcelles />}
      ...
      {section==='plants-pdt'     && <PlantsPDT />}
      {section==='cereales'       && <Cereales />}
      {section==='recolte-pdt'    && <RecoltePdt />}
